...
const FeedbackVisual = ({ 
  ...
  return (
    <div className={`fixed top-4 right-4 z-50 max-w-sm w-full transform transition-all duration-300 ease-in-out ${
      ...
      <div className={`rounded-lg p-4 shadow-lg border ${estilos.bg} ${estilos.border}`}>
        <div className="flex items-start">
          <div className={`flex-shrink-0 ${estilos.texto}`}>
            {estilos.icone}
          </div>
          ...
          {onFechar && (
            <div className="ml-4 flex-shrink-0">
              <button
                ...
                className={`inline-flex rounded-md p-1.5 ${estilos.texto} hover:bg-black hover:bg-opacity-10 focus:outline-none focus:ring-2 focus:ring-offset-2`}
              >
