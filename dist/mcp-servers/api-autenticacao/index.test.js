...
const mockServicoAutenticacao = (0, jest_mock_extended_1.mock)();
// Mockar a instância do ServicoAutenticacao para que os testes usem o mock
jest.mocked(ServicoAutenticacao_1.ServicoAutenticacao).mockImplementation(() => mockServicoAutenticacao);
// Importar o app *depois* de mockar o serviço para garantir que o mock seja usado
const index_1 = __importDefault(require("./index")); // Assumindo que o index.ts exporta o app
