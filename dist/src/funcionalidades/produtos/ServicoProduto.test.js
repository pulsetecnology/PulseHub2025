...
const ServicoProduto_1 = require("./ServicoProduto");
...
describe('ServicoProduto', () => {
    let servicoProduto;
    let mockRepositorioProduto;
    beforeEach(() => {
        servicoProduto = new ServicoProduto_1.ServicoProduto();
        mockRepositorioProduto = new RepositorioProdutoPrisma_1.RepositorioProdutoPrisma();
        jest.clearAllMocks();
    });
    const mockProduto = {
        id: '1',
...
//# sourceMappingURL=ServicoProduto.test.js.map