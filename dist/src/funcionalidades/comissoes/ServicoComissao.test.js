...
const ServicoComissao_1 = require("./ServicoComissao");
...
describe('ServicoComissao', () => {
    let servicoComissao;
    let mockRepositorioComissao;
    beforeEach(() => {
        servicoComissao = new ServicoComissao_1.ServicoComissao();
        mockRepositorioComissao = new RepositorioComissaoPrisma_1.RepositorioComissaoPrisma();
        jest.clearAllMocks();
    });
    const mockComissao = {
        id: '1',
...
//# sourceMappingURL=ServicoComissao.test.js.map