...
const ServicoPedido_1 = require("@src/funcionalidades/pedidos/ServicoPedido");
const jest_mock_extended_1 = require("jest-mock-extended");
const index_1 = __importDefault(require("./index"));
// Mock do ServicoPedido
jest.mock('../../../src/funcionalidades/pedidos/ServicoPedido');
const mockServicoPedido = (0, jest_mock_extended_1.mock)();
// Mockar a instância do ServicoPedido para que os testes usem o mock
jest.mocked(ServicoPedido_1.ServicoPedido).mockImplementation(() => mockServicoPedido);
const app = (0, express_1.default)();
app.use(express_1.default.json());
app.use('/pedidos', index_1.default);
describe('API de Pedidos', () => {
    ...
    describe('GET /pedidos', () => {
        it('deve retornar todos os pedidos', async () => {
            ...
            const res = await (0, supertest_1.default)(app).get('/pedidos');
    ...
    describe('GET /pedidos/:id', () => {
        it('deve retornar um pedido pelo ID', async () => {
            ...
            const res = await (0, supertest_1.default)(app).get('/pedidos/1');
            expect(res.statusCode).toEqual(200);
            expect(res.body).toEqual(mockPedido);
        ...
        it('deve retornar 404 se o pedido não for encontrado', async () => {
            ...
            const res = await (0, supertest_1.default)(app).get('/pedidos/999');
    ...
    describe('DELETE /pedidos/:id', () => {
        it('deve deletar um pedido e retornar 204', async () => {
            ...
            const res = await (0, supertest_1.default)(app).delete('/pedidos/1');
        ...
        it('deve retornar 404 se o pedido não for encontrado para exclusão', async () => {
            ...
            const res = await (0, supertest_1.default)(app).delete('/pedidos/999');
            expect(res.statusCode).toEqual(404);
